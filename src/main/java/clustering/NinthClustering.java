 ...
 * the intersection of normalized histograms for 9-partitioned sub-regions
 * within each cluster's average image.
 */
public class NinthClustering extends ClusteringAlgorithm {
    /**
     * Constructs an instance of NinthClustering with a specified number of target
     ...
     */
    public NinthClustering(int targetNumClusters, List<PGMImage> images) {
     ...
     * average image into 9 sub-regions and calculating the intersection of
     * normalized
     * histograms for each corresponding partition. The final similarity is the
     * average
     * intersection across all 9 partitions.
     *
    ...
    protected double computeSimilarity(Cluster cluster1, Cluster cluster2) {
        int[][] subHistograms1 = cluster1.getClusterPartitionHistograms(9);
        int[][] subHistograms2 = cluster2.getClusterPartitionHistograms(9);
     ...
     * the merged cluster to maintain consistency with 9-partitioned sub-regions.
     *
    ...
    protected void mergeClusters(Cluster cluster1, Cluster cluster2) {
        ...
        cluster1.updateClusterPartitionHistograms(9);
    }
}